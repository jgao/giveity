...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, :donation => { :money => @donation.money, :organization_id => @donation.organization_id, :time => @donation.time, :user_id => @donation.user_id }
    end
  ...
  test "should update donation" do
    put :update, :id => @donation, :donation => { :money => @donation.money, :organization_id => @donation.organization_id, :time => @donation.time, :user_id => @donation.user_id }
    assert_redirected_to donation_path(assigns(:donation))
  end
